...
export default function App() {
  ...
  const [brandName, setBrandName] = useState("Alisha-আঁচল");
  const [invoiceNo, setInvoiceNo] = useState("ALI-54120");
  const [deliveryPartner, setDeliveryPartner] = useState("Steadfast Alisha-আঁচল");
  ...
  const [companyEmail, setCompanyEmail] = useState("alishaachol7@gmail.com");
  const [companyAddress, setCompanyAddress] = useState("House No-15, Road No-02, Block-C, Shaplabag, Tilagor, Sylhet");
